...
export async function before(m, { conn, participants }) {
  ...
  try {     
    ...
    const _translate = JSON.parse(fs.readFileSync('./src/languages/en/_detectEvents.js.json'));
    const tradutor = _translate._detectevents;

    let groupName = "el grupo";
    let groupMetadata = groupMetadataCache.get(m.chat);
    let pp = 'https://raw.githubusercontent.com/hoodDevs/Astrid/master/src/avatar_contact.png';
    let img = null;
