let handler = async (m, {conn, isPrems}) => {
  ...
  const tradutor = _translate.plugins.rpg_minar_astridcoins;
  ...
  await conn.sendFile(m.chat, pp, 'astrid.jpg', text, m);
  user.lastcoins = new Date * 1;
};
handler.help = ['minar2'];
handler.tags = ['xp'];
handler.command = ['minar2', 'miming2', 'mine2', 'minarastridcoins', 'minarcoins', 'minarastrid'];
handler.fail = null;
handler.exp = 0;
